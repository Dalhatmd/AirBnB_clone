...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_state_id_is_public_class_attrib(self):
        cy = City()
    ...
    def test_two_cities_unique_(self):
        cy1 = City()
        cy2 = City()
        self.assertNotEqual(cy1.id, cy2.id)

    def test_two_cities_different_created(self):
        cy1 = City()
        sleep(0.05)
        cy2 = City()
        self.assertLess(cy1.created_at, cy2.created_at)

    def test_two_cities_different_updated(self):
        cy1 = City()
        sleep(0.05)
        cy2 = City()
