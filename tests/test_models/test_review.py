...
class TestReview_instantiation(unittest.TestCase):
    ...
    def test_place_id_is_public_class_attrib(self):
        rv = Review()
    ...
    def test_two_reviews_unique_(self):
        rv1 = Review()
        rv2 = Review()
        self.assertNotEqual(rv1.id, rv2.id)

    def test_two_reviews_different_created(self):
        rv1 = Review()
        sleep(0.05)
        rv2 = Review()
        self.assertLess(rv1.created_at, rv2.created_at)

    def test_two_reviews_different_updated(self):
        rv1 = Review()
        sleep(0.05)
        rv2 = Review()
