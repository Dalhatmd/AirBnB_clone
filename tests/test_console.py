...
class TestHBNBCommand_prompting(unittest.TestCase):
    ...
    def test_prompt_stri(self):
        self.assertEqual("(hbnb) ", HBNBCommand.prompt)

    def test_empty_li(self):
...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_qu(self):
        h = "Quit command to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help quit"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_crea(self):
    ...
    def test_help_E(self):
        h = "EOF signal to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_sh(self):
...
class TestHBNBCommand_exit(unittest.TestCase):
    ...
    def test_quit_exi(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertTrue(HBNBCommand().onecmd("quit"))

    def test_EOF_exi(self):
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_create(unittest.TestCase):
    ...
    def test_create_missing_cla(self):
        correct = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create"))
            self.assertEqual(correct, output.getvalue().strip())

    def test_create_invalid_cla(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create MyModel"))
            self.assertEqual(correct, output.getvalue().strip())

    def test_create_invalid_synt(self):
...
class TestHBNBCommand_show(unittest.TestCase):
    ...
    def test_show_missing_cla(self):
        correct = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_invalid_cla(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_missing_id_space_notati(self):
    ...
    def test_show_missing_id_dot_notati(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_no_instance_found_space_notati(self):
    ...
    def test_show_no_instance_found_dot_notati(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_objects_space_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
...
class TestHBNBCommand_destroy(unittest.TestCase):
    ...
    def test_destroy_missing_cla(self):
        correct = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_invalid_cla(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_id_missing_space_notati(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_id_missing_dot_notati(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_invalid_id_space_notati(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_invalid_id_dot_notati(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_objects_space_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_objects_dot_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_all(unittest.TestCase):
    ...
    def test_all_objects_dot_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_all_single_object_space_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_all_single_object_dot_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_missing_cla(self):
        correct = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_invalid_cla(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_missing_id_space_notati(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_missing_id_dot_notati(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_invalid_id_space_notati(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_invalid_id_dot_notati(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_missing_attr_name_space_notati(self):
    ...
    def test_update_missing_attr_name_dot_notati(self):
        correct = "** attribute name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
    ...
    def test_update_missing_attr_value_space_notati(self):
    ...
    def test_update_missing_attr_value_dot_notati(self):
        correct = "** value missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_string_attr_space_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_string_attr_dot_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
    ...
    def test_update_valid_int_attr_space_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_int_attr_dot_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
    ...
    def test_update_valid_float_attr_space_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_float_attr_dot_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
    ...
    def test_update_valid_dictionary_space_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
        testCmd = "update BaseModel {} ".format(testId)
    ...
    def test_update_valid_dictionary_dot_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
        testCmd = "BaseModel.update({}".format(testId)
    ...
    def test_update_valid_dictionary_with_int_space_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} ".format(testId)
    ...
    def test_update_valid_dictionary_with_int_dot_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "Place.update({}, ".format(testId)
    ...
    def test_update_valid_dictionary_with_float_space_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} ".format(testId)
    ...
    def test_update_valid_dictionary_with_float_dot_notati(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "Place.update({}, ".format(testId)
...
class TestHBNBCommand_count(unittest.TestCase):
    ...
    def test_count_invalid_cla(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("MyModel.count()"))
            self.assertEqual("0", output.getvalue().strip())

    def test_count_obje(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
        with patch("sys.stdout", new=StringIO()) as output:
